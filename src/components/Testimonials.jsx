...
const testimonials = [
  ...
  },
  {
    ...
    attribution: "Steve · Executive Leader",
    initials: "S",
  },
  {
    quote:
    ...
    attribution: "Sprint participant · Fortune 500 Director",
    initials: "SP",
  },
];
    ...
    <section className={styles.testimonials} id="testimonials">
      <div className="container">
        <div className={styles.gridMain}>
          <div className={styles.testimonialsHeaderSide}>
            <span className="eyebrow">Impact & Feedback</span>
            <h2 className={styles.testimonialsTitle}>Not before-and-after. During and after.</h2>
            <p className={styles.testimonialsSub}>
              Coaching isn't just about reaching a final destination. It's about the growth that happens in the middle of the work.
            </p>
          </div>

          <div className={styles.testimonialsCardsSide}>
            {testimonials.map((t, i) => (
              <div key={i} className={styles.quoteCardV2}>
